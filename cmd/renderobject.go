...
import (
	...
	"github.com/ahyangyi/gorender/internal/spritesheet"
...
func processFile(inputFilename string) {
	...
	timingutils.Time("Voxel processing", flags.OutputTime, func() {
		processedObject = voxelobject.GetProcessedVoxelObject(object, &palette, renderManifest.TiledNormals, renderManifest.TilingMode, renderManifest.SolidBase, renderManifest.Slope, renderManifest.SlopeType)
	})
